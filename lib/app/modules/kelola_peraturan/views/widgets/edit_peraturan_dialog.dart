...
class EditPeraturanDialog extends GetView<KelolaPeraturanController> {
  final PeraturanModel kategori;

  const EditPeraturanDialog({super.key, required this.kategori});
  ...
  static void show(PeraturanModel kategori) {
    ...
    Get.dialog(
      EditPeraturanDialog(kategori: kategori),
