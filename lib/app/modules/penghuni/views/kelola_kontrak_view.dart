...
class KelolaKontrakView extends StatelessWidget {
  const KelolaKontrakView({super.key});
                  ...
                  child: SingleChildScrollView(
                    ...
                    child: Column(
                      children: [
                        ...
                        _buildCurrentContractInfo(controller),
  ...
  Widget _buildCurrentContractInfo(KelolaKontrakController controller) {
    return Container(
      padding: const EdgeInsets.all(16),
            ...
            children: [
              ...
              Text(
                ...
                style: TextStyle(
                  fontSize: 14,
                  fontWeight: FontWeight.w600,
                  color: controller.remainingTimeLabel == 'Sudah berakhir'
  ...
  Widget _buildTabs(KelolaKontrakController controller) {
    return Obx(
      () => Container(
        decoration: BoxDecoration(
          color: Colors.white,
  ...
  // Perpanjang, Edit, dan Akhiri content methods sama seperti di bottom sheet
  // Saya akan copy paste dari bottom sheet dengan sedikit modifikasi
                ...
                _buildSistemPembayaranPickerField(
                  ...
                  onTap: isEnabled
                      ? () => _showSistemPembayaranPicker(
                          ...
                          options: options,
                          onSelected:
                              controller.pilihSistemPembayaranPerpanjang,
